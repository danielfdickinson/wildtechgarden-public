...
I have written an article about [Gitea on a Raspberry Pi](/deploy-admin/2021-05-13-gitea-pi) but now use Gitea in a docker container on [an Intel-NUC-like SBC as a server](/deploy-admin/2021-05-18-intel-nuc-like-server).
...
2. Change the permssions on /var/lib/gitolite3/projects.list to read for all: ``sudo chmod ugo+r /var/lib/gitolite3/projects.list``
...
### Configure Gitweb (including Apache2 Configuration)

#### Place Static Webserver Files
...
# Allow these options to be overriden on a per-repo basis
...
### Enable Needed Apache2 Modules and Virtual Host
